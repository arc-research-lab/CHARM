...
PLIO *in_r0_small  = new PLIO("in_r0_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r1_small  = new PLIO("in_r1_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r2_small  = new PLIO("in_r2_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r3_small  = new PLIO("in_r3_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r4_small  = new PLIO("in_r4_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r5_small  = new PLIO("in_r5_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r6_small  = new PLIO("in_r6_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_r7_small  = new PLIO("in_r7_small",  adf::plio_128_bits, "data/input0.txt", 250);
PLIO *in_c0_small  = new PLIO("in_c0_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c1_small  = new PLIO("in_c1_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c2_small  = new PLIO("in_c2_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c3_small  = new PLIO("in_c3_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c4_small  = new PLIO("in_c4_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c5_small  = new PLIO("in_c5_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c6_small  = new PLIO("in_c6_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c7_small  = new PLIO("in_c7_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c8_small  = new PLIO("in_c8_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c9_small  = new PLIO("in_c9_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c10_small  = new PLIO("in_c10_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c11_small  = new PLIO("in_c11_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c12_small  = new PLIO("in_c12_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c13_small  = new PLIO("in_c13_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c14_small  = new PLIO("in_c14_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_c15_small  = new PLIO("in_c15_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *out_0_small = new PLIO("out_0_small", adf::plio_128_bits, "./data/output_0_small.txt", 250);
PLIO *out_1_small = new PLIO("out_1_small", adf::plio_128_bits, "./data/output_1_small.txt", 250);
PLIO *out_2_small = new PLIO("out_2_small", adf::plio_128_bits, "./data/output_2_small.txt", 250);
PLIO *out_3_small = new PLIO("out_3_small", adf::plio_128_bits, "./data/output_3_small.txt", 250);
PLIO *out_4_small = new PLIO("out_4_small", adf::plio_128_bits, "./data/output_4_small.txt", 250);
PLIO *out_5_small = new PLIO("out_5_small", adf::plio_128_bits, "./data/output_5_small.txt", 250);
PLIO *out_6_small = new PLIO("out_6_small", adf::plio_128_bits, "./data/output_6_small.txt", 250);
PLIO *out_7_small = new PLIO("out_7_small", adf::plio_128_bits, "./data/output_7_small.txt", 250);

mm_x64_x4_graph<COL_OFFSET_LARGE,ROW_OFFSET_LARGE> myGraph_large;
mm_x32_x4_graph<COL_OFFSET_SMALL,ROW_OFFSET_SMALL> myGraph_small;
...
connect<> netic8_small(platform.src[64], myGraph_small.in_col[8]);
connect<> netic9_small(platform.src[65], myGraph_small.in_col[9]);
connect<> netic10_small(platform.src[66], myGraph_small.in_col[10]);
connect<> netic11_small(platform.src[67], myGraph_small.in_col[11]);
connect<> netic12_small(platform.src[68], myGraph_small.in_col[12]);
connect<> netic13_small(platform.src[69], myGraph_small.in_col[13]);
connect<> netic14_small(platform.src[70], myGraph_small.in_col[14]);
connect<> netic15_small(platform.src[71], myGraph_small.in_col[15]);
...
connect<> neto4_small(myGraph_small.out[4],  platform.sink[20]);
connect<> neto5_small(myGraph_small.out[5],  platform.sink[21]);
connect<> neto6_small(myGraph_small.out[6],  platform.sink[22]);
connect<> neto7_small(myGraph_small.out[7],  platform.sink[23]);
