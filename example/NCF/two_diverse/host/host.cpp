...
int main(int argc, char** argv) {
    ...
    //layer8
    std::vector<std::vector<float>>layer8_in0(layer[8][0],std::vector<float>(layer[8][1],1.0));
    std::vector<std::vector<float>>layer8_in1(layer[8][1],std::vector<float>(layer[8][2],1.0));
    std::vector<std::vector<float>>layer8_golden(layer[8][0],std::vector<float>(layer[8][2],1.0));
    ...
    for (int m = 0; m < layer[8][0]; m++) {
        for (int k = 0; k < layer[8][1]; k++) {
            layer8_in0[m][k]= (rand()%5)*(float)1.0;
        }
    }
    srand (time(0));
    for (int k = 0; k < layer[8][1]; k++) {
        for (int n = 0; n < layer[8][2]; n++) {
            layer8_in1[k][n]= (rand()%5)*(float)1.0;
        }
    }
    ...
    //layer8
    xrtBufferHandle bohdl_layer8_in0 = xrtBOAlloc(dhdl, (layer[8][0]*layer[8][1]) * sizeof(float), 0, 0);
    auto bomapped_layer8_in0 = reinterpret_cast<float*>(xrtBOMap(bohdl_layer8_in0));
    xrtBufferHandle bohdl_layer8_in1 = xrtBOAlloc(dhdl, (layer[8][1]*layer[8][2]) * sizeof(float), 0, 0);
    auto bomapped_layer8_in1 = reinterpret_cast<float*>(xrtBOMap(bohdl_layer8_in1));
    ...
    //layer8
    xrtBOSync(bohdl_layer8_in0, XCL_BO_SYNC_BO_TO_DEVICE , (layer[8][0]*layer[8][1])* sizeof(float),0);
    xrtBOSync(bohdl_layer8_in1, XCL_BO_SYNC_BO_TO_DEVICE , (layer[8][1]*layer[8][2])* sizeof(float),0);
    ...
    //layer8
    xrtBufferHandle bohdl_layer8_out = xrtBOAlloc(dhdl, (layer[8][0]*layer[8][2]) * sizeof(float), 0, 0);
    auto bomapped_layer8_out = reinterpret_cast<float*>(xrtBOMap(bohdl_layer8_out));
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer1_in0, bohdl_layer1_in1,bohdl_layer1_out,(layer[1][0]/(M_acc0)),(layer[1][1]/K_acc0),(layer[1][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer2_in0, bohdl_layer2_in1,bohdl_layer2_out,(layer[2][0]/(M_acc0)),(layer[2][1]/K_acc0),(layer[2][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer3_in0, bohdl_layer3_in1,bohdl_layer3_out,(layer[3][0]/(M_acc0)),(layer[3][1]/K_acc0),(layer[3][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer4_in0, bohdl_layer4_in1,bohdl_layer4_out,(layer[4][0]/(M_acc0)),(layer[4][1]/K_acc0),(layer[4][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer5_in0, bohdl_layer5_in1,bohdl_layer5_out,(layer[5][0]/(M_acc0)),(layer[5][1]/K_acc0),(layer[5][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer6_in0, bohdl_layer6_in1,bohdl_layer6_out,(layer[6][0]/(M_acc0)),(layer[6][1]/K_acc0),(layer[6][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer7_in0, bohdl_layer7_in1,bohdl_layer7_out,(layer[7][0]/(M_acc0)),(layer[7][1]/K_acc0),(layer[7][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    dma_rhdl_small = xrtKernelRun(dma_khdl_small, bohdl_layer8_in0, bohdl_layer8_in1,bohdl_layer8_out,(layer[8][0]/(M_acc0)),(layer[8][1]/K_acc0),(layer[8][2]/N_acc0),
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,//A_small 8
                        nullptr, nullptr, nullptr, nullptr,
                        nullptr, nullptr, nullptr, nullptr,
    ...
    xrtBOSync(bohdl_layer8_out, XCL_BO_SYNC_BO_FROM_DEVICE , (layer[8][0]*layer[8][2])* sizeof(float),/*OFFSET=*/ 0);
...

    {
        ...
        for (int m = 0; m < layer[8][0]; m++) {
            for (int n = 0; n < layer[8][2]; n++) {
                sum =0;
                for (int k = 0; k < layer[8][1]; k++) {
                    sum=sum+layer8_in0[m][k]*layer8_in1[k][n];
                }
                layer8_golden[m][n]=sum;
            }
        }

        for (int m = 0; m < layer[8][0]; m++) {
            for (int n = 0; n < layer[8][2]; n++) {
                if(abs((float)(bomapped_layer8_out[m+n*layer[8][0]])-layer8_golden[m][n])>=1e-3){
                    errorCount++;
                }
            }
        }
