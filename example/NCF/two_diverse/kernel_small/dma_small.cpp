    ...
    if(enable){
        ...
        for (int k = 0; k < PACKET_NUM*Y*X*Z; k++) {
            ...
            if(k<10){
                ...
                int cnt=k-10;
                ID=cnt%PACKET_NUM;
                tile=(4-(cnt%PACKET_NUM)+cnt/PACKET_NUM)%(Y);
             ...
             axis_stream& rxC_4, axis_stream& rxC_5, axis_stream& rxC_6, axis_stream& rxC_7)
{
    ...
    #pragma HLS bind_storage variable=buff0_A type=RAM_1P impl=URAM
    ...
    #pragma HLS bind_storage variable=buff1_A type=RAM_1P impl=URAM
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendB<2> (buff1_B[2],txB_2,rd>0&&rd<Total_rd+1);
            sendB<3> (buff1_B[3],txB_3,rd>0&&rd<Total_rd+1);
            sendB<4> (buff1_B[4],txB_4,rd>0&&rd<Total_rd+1);
            sendB<5> (buff1_B[5],txB_5,rd>0&&rd<Total_rd+1);
            sendB<6> (buff1_B[6],txB_6,rd>0&&rd<Total_rd+1);
            sendB<7> (buff1_B[7],txB_7,rd>0&&rd<Total_rd+1);
            sendB<8> (buff1_B[8],txB_8,rd>0&&rd<Total_rd+1);
            sendB<9> (buff1_B[9],txB_9,rd>0&&rd<Total_rd+1);
            sendB<10>(buff1_B[10],txB_10,rd>0&&rd<Total_rd+1);
            sendB<11>(buff1_B[11],txB_11,rd>0&&rd<Total_rd+1);
            sendB<12>(buff1_B[12],txB_12,rd>0&&rd<Total_rd+1);
            sendB<13>(buff1_B[13],txB_13,rd>0&&rd<Total_rd+1);
            sendB<14>(buff1_B[14],txB_14,rd>0&&rd<Total_rd+1);
            sendB<15>(buff1_B[15],txB_15,rd>0&&rd<Total_rd+1);
            ...
            sendB<2> (buff0_B[2],txB_2,rd>0&&rd<Total_rd+1);
            sendB<3> (buff0_B[3],txB_3,rd>0&&rd<Total_rd+1);
            sendB<4> (buff0_B[4],txB_4,rd>0&&rd<Total_rd+1);
            sendB<5> (buff0_B[5],txB_5,rd>0&&rd<Total_rd+1);
            sendB<6> (buff0_B[6],txB_6,rd>0&&rd<Total_rd+1);
            sendB<7> (buff0_B[7],txB_7,rd>0&&rd<Total_rd+1);
            sendB<8> (buff0_B[8],txB_8,rd>0&&rd<Total_rd+1);
            sendB<9> (buff0_B[9],txB_9,rd>0&&rd<Total_rd+1);
            sendB<10>(buff0_B[10],txB_10,rd>0&&rd<Total_rd+1);
            sendB<11>(buff0_B[11],txB_11,rd>0&&rd<Total_rd+1);
            sendB<12>(buff0_B[12],txB_12,rd>0&&rd<Total_rd+1);
            sendB<13>(buff0_B[13],txB_13,rd>0&&rd<Total_rd+1);
            sendB<14>(buff0_B[14],txB_14,rd>0&&rd<Total_rd+1);
            sendB<15>(buff0_B[15],txB_15,rd>0&&rd<Total_rd+1);
            reshapeC<0>(buff0_C[0],rxC_0,rd>0&&rd<Total_rd+1);
            reshapeC<1>(buff0_C[1],rxC_1,rd>0&&rd<Total_rd+1);
            reshapeC<2>(buff0_C[2],rxC_2,rd>0&&rd<Total_rd+1);
            reshapeC<3>(buff0_C[3],rxC_3,rd>0&&rd<Total_rd+1);
...
void dma_small(ap_uint<AXI_WIDTH_512>* ina, ap_uint<AXI_WIDTH_512>* inb, ap_uint<AXI_WIDTH_256>* out0, const int TX, const int TY, const int TZ,
            axis_stream& txA_0,  axis_stream& txA_1,  axis_stream& txA_2,  axis_stream& txA_3,
            axis_stream& txA_4,  axis_stream& txA_5,  axis_stream& txA_6,  axis_stream& txA_7,
            axis_stream& txB_0,  axis_stream& txB_1,  axis_stream& txB_2,  axis_stream& txB_3,
            axis_stream& txB_4,  axis_stream& txB_5,  axis_stream& txB_6,  axis_stream& txB_7,
