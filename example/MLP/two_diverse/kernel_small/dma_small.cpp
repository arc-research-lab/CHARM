...
static const unsigned int tileB0[16]={2, 1, 0, 1, 3, 2, 1, 0, 2,3,2,1,3,2,3,2};
static const unsigned int tileB2[6]={3, 2, 3, 3, 2, 3};
        ...
        for (int k = 0; k < PACKET_NUM*Y*X*Z; k++) {
            ...
            if(k<10){
                ...
                if(cnt<32){
                    ...
                    tile=(4-(cnt%PACKET_NUM)+(cnt/PACKET_NUM))%Y+2;
                }
            }
            else{
