...
static const unsigned int packet_id0[4]={0, 0, 1, 1};
static const unsigned int tile0[4]={0,1,0,1};
    ...
    for (int batch_dot=0; batch_dot<D0*D1;batch_dot++){
        ...
        for (int rd=0; rd<Total_rd+2;rd++){
            ...
            if(rd%2==0&&c_flg==0){
                ...
                sendA<2>(buff1_A[2],txA_2,rd>0&&rd<Total_rd+1);
                sendA<3>(buff1_A[3],txA_3,rd>0&&rd<Total_rd+1);
                sendA<4>(buff1_A[4],txA_4,rd>0&&rd<Total_rd+1);
                sendA<5>(buff1_A[5],txA_5,rd>0&&rd<Total_rd+1);
                sendA<6>(buff1_A[6],txA_6,rd>0&&rd<Total_rd+1);
                sendA<7>(buff1_A[7],txA_7,rd>0&&rd<Total_rd+1);
                ...
                sendA<2>(buff0_A[2],txA_2,rd>0&&rd<Total_rd+1);
                sendA<3>(buff0_A[3],txA_3,rd>0&&rd<Total_rd+1);
                sendA<4>(buff0_A[4],txA_4,rd>0&&rd<Total_rd+1);
                sendA<5>(buff0_A[5],txA_5,rd>0&&rd<Total_rd+1);
                sendA<6>(buff0_A[6],txA_6,rd>0&&rd<Total_rd+1);
                sendA<7>(buff0_A[7],txA_7,rd>0&&rd<Total_rd+1);
