...
static const unsigned int packet_id0[8]={0,0,1,1,2,2,3,3};
...
template<int NC>
void sendA(ap_uint<PLIO_WIDTH> a_buf[X*Y][LEFT_SIZE*PACKET_NUM],axis_stream& txA0, axis_stream& txA1,bool enable){
...
template<int NC>
void sendB(ap_uint<PLIO_WIDTH> b_buf[Y*Z][RIGHT_SIZE*PACKET_NUM], axis_stream& txB0, axis_stream& txB1, axis_stream& txB2, axis_stream& txB3, bool enable){
#pragma HLS inline off
    if(enable){
        axis_pkt tmp;
        float data_temp[2][4];
             ...
             axis_stream& rxC_12, axis_stream& rxC_13, axis_stream& rxC_14, axis_stream& rxC_15)
{
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendA<0>(buff1_A[0],txA_0,txA_1,rd>0&&rd<Total_rd+1);
            sendA<1>(buff1_A[1],txA_2,txA_3,rd>0&&rd<Total_rd+1);
            sendA<2>(buff1_A[2],txA_4,txA_5,rd>0&&rd<Total_rd+1);
            sendA<3>(buff1_A[3],txA_6,txA_7,rd>0&&rd<Total_rd+1);
            sendA<4>(buff1_A[4],txA_8,txA_9,rd>0&&rd<Total_rd+1);
            sendA<5>(buff1_A[5],txA_10,txA_11,rd>0&&rd<Total_rd+1);
            sendA<6>(buff1_A[6],txA_12,txA_13,rd>0&&rd<Total_rd+1);
            sendA<7>(buff1_A[7],txA_14,txA_15,rd>0&&rd<Total_rd+1);

            sendB<0>(buff1_B[0],txB_0,txB_1,txB_2,txB_3,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB_4,txB_5,txB_6,txB_7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB_8,txB_9,txB_10,txB_11,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB_12,txB_13,txB_14,txB_15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB_16,txB_17,txB_18,txB_19,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB_20,txB_21,txB_22,txB_23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff1_B[6],txB_24,txB_25,txB_26,txB_27,rd>0&&rd<Total_rd+1);
            sendB<7>(buff1_B[7],txB_28,txB_29,txB_30,txB_31,rd>0&&rd<Total_rd+1);
            ...
            sendA<0>(buff0_A[0],txA_0,txA_1,rd>0&&rd<Total_rd+1);
            sendA<1>(buff0_A[1],txA_2,txA_3,rd>0&&rd<Total_rd+1);
            sendA<2>(buff0_A[2],txA_4,txA_5,rd>0&&rd<Total_rd+1);
            sendA<3>(buff0_A[3],txA_6,txA_7,rd>0&&rd<Total_rd+1);
            sendA<4>(buff0_A[4],txA_8,txA_9,rd>0&&rd<Total_rd+1);
            sendA<5>(buff0_A[5],txA_10,txA_11,rd>0&&rd<Total_rd+1);
            sendA<6>(buff0_A[6],txA_12,txA_13,rd>0&&rd<Total_rd+1);
            sendA<7>(buff0_A[7],txA_14,txA_15,rd>0&&rd<Total_rd+1);

            sendB<0>(buff0_B[0],txB_0,txB_1,txB_2,txB_3,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB_4,txB_5,txB_6,txB_7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB_8,txB_9,txB_10,txB_11,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB_12,txB_13,txB_14,txB_15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB_16,txB_17,txB_18,txB_19,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB_20,txB_21,txB_22,txB_23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff0_B[6],txB_24,txB_25,txB_26,txB_27,rd>0&&rd<Total_rd+1);
            sendB<7>(buff0_B[7],txB_28,txB_29,txB_30,txB_31,rd>0&&rd<Total_rd+1);
