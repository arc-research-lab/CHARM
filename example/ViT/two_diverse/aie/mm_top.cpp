...
PLIO *in_r0_small  = new PLIO("in_r0_small",  adf::plio_128_bits, "data/input1.txt", 250);
PLIO *in_r1_small  = new PLIO("in_r1_small",  adf::plio_128_bits, "data/input1.txt", 250);
...
PLIO *out_0_small  = new PLIO("out_0_small", adf::plio_128_bits, "./data/output_0.txt", 250);
mm_x64_x4_graph<COL_OFFSET_LARGE,ROW_OFFSET_LARGE> myGraph_large;
mm_x4_x2_graph<COL_OFFSET_SMALL,ROW_OFFSET_SMALL> myGraph_small;
	
	simulation::platform<52,17> platform(
                                  in_r0_large,
                                  in_r1_large,
                                  in_r2_large,
                                  in_r3_large,
...
connect<> netic0_small(platform.src[50], myGraph_small.in_col[0]);
connect<> netic1_small(platform.src[51], myGraph_small.in_col[1]);
