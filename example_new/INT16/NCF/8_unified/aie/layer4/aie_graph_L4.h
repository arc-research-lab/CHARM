...
class mm_k1_B3_L4: public graph {
  private:
  ...
  public:
    ...
    mm_k1_B3_L4() {
      ...
      for (int i=0; i<L4_NUM_KERNEL;i++){
        if(i==0){
          mm[i] = kernel::create(mm5_kernel0_L4);
          source(mm[i]) = "mm5_kernel0_L4.cc";
        }
        else if(i==L4_NUM_KERNEL-1){
          mm[i] = kernel::create(mm5_kernel2_L4);
          source(mm[i]) = "mm5_kernel2_L4.cc";
        }
        
        else{
          mm[i] = kernel::create(mm5_kernel1_L4);
          source(mm[i]) = "mm5_kernel1_L4.cc";
        }
