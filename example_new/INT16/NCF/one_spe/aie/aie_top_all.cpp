...
PLIO* out32_L0 = new PLIO("out32_L0", adf::plio_128_bits, "data/output32.txt",230);
PLIO* out33_L0 = new PLIO("out33_L0", adf::plio_128_bits, "data/output33.txt",230);
PLIO* out34_L0 = new PLIO("out34_L0", adf::plio_128_bits, "data/output34.txt",230);
PLIO* out35_L0 = new PLIO("out35_L0", adf::plio_128_bits, "data/output35.txt",230);
PLIO* out36_L0 = new PLIO("out36_L0", adf::plio_128_bits, "data/output36.txt",230);
PLIO* out37_L0 = new PLIO("out37_L0", adf::plio_128_bits, "data/output37.txt",230);
PLIO* out38_L0 = new PLIO("out38_L0", adf::plio_128_bits, "data/output38.txt",230);
PLIO* out39_L0 = new PLIO("out39_L0", adf::plio_128_bits, "data/output39.txt",230);
PLIO* out40_L0 = new PLIO("out40_L0", adf::plio_128_bits, "data/output40.txt",230);
PLIO* out41_L0 = new PLIO("out41_L0", adf::plio_128_bits, "data/output41.txt",230);
PLIO* out42_L0 = new PLIO("out42_L0", adf::plio_128_bits, "data/output42.txt",230);
PLIO* out43_L0 = new PLIO("out43_L0", adf::plio_128_bits, "data/output43.txt",230);
PLIO* out44_L0 = new PLIO("out44_L0", adf::plio_128_bits, "data/output44.txt",230);
PLIO* out45_L0 = new PLIO("out45_L0", adf::plio_128_bits, "data/output45.txt",230);
PLIO* out46_L0 = new PLIO("out46_L0", adf::plio_128_bits, "data/output46.txt",230);
PLIO* out47_L0 = new PLIO("out47_L0", adf::plio_128_bits, "data/output47.txt",230);

simulation::platform<80, 48> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_lhs_in24_L0 (platform.src[24], mm_graph0.in_lhs[24][0]);
connect<> net_lhs_in25_L0 (platform.src[25], mm_graph0.in_lhs[25][0]);
connect<> net_lhs_in26_L0 (platform.src[26], mm_graph0.in_lhs[26][0]);
connect<> net_lhs_in27_L0 (platform.src[27], mm_graph0.in_lhs[27][0]);
connect<> net_lhs_in28_L0 (platform.src[28], mm_graph0.in_lhs[28][0]);
connect<> net_lhs_in29_L0 (platform.src[29], mm_graph0.in_lhs[29][0]);
connect<> net_lhs_in30_L0 (platform.src[30], mm_graph0.in_lhs[30][0]);
connect<> net_lhs_in31_L0 (platform.src[31], mm_graph0.in_lhs[31][0]);
...
connect<> net_rhs_in4_L0 (platform.src[36], mm_graph0.in_rhs[4][0]);
connect<> net_rhs_in5_L0 (platform.src[37], mm_graph0.in_rhs[5][0]);
connect<> net_rhs_in6_L0 (platform.src[38], mm_graph0.in_rhs[6][0]);
connect<> net_rhs_in7_L0 (platform.src[39], mm_graph0.in_rhs[7][0]);
connect<> net_rhs_in8_L0 (platform.src[40], mm_graph0.in_rhs[8][0]);
connect<> net_rhs_in9_L0 (platform.src[41], mm_graph0.in_rhs[9][0]);
connect<> net_rhs_in10_L0 (platform.src[42], mm_graph0.in_rhs[10][0]);
connect<> net_rhs_in11_L0 (platform.src[43], mm_graph0.in_rhs[11][0]);
connect<> net_rhs_in12_L0 (platform.src[44], mm_graph0.in_rhs[12][0]);
connect<> net_rhs_in13_L0 (platform.src[45], mm_graph0.in_rhs[13][0]);
connect<> net_rhs_in14_L0 (platform.src[46], mm_graph0.in_rhs[14][0]);
connect<> net_rhs_in15_L0 (platform.src[47], mm_graph0.in_rhs[15][0]);
connect<> net_rhs_in16_L0 (platform.src[48], mm_graph0.in_rhs[16][0]);
connect<> net_rhs_in17_L0 (platform.src[49], mm_graph0.in_rhs[17][0]);
connect<> net_rhs_in18_L0 (platform.src[50], mm_graph0.in_rhs[18][0]);
connect<> net_rhs_in19_L0 (platform.src[51], mm_graph0.in_rhs[19][0]);
connect<> net_rhs_in20_L0 (platform.src[52], mm_graph0.in_rhs[20][0]);
connect<> net_rhs_in21_L0 (platform.src[53], mm_graph0.in_rhs[21][0]);
connect<> net_rhs_in22_L0 (platform.src[54], mm_graph0.in_rhs[22][0]);
connect<> net_rhs_in23_L0 (platform.src[55], mm_graph0.in_rhs[23][0]);
connect<> net_rhs_in24_L0 (platform.src[56], mm_graph0.in_rhs[24][0]);
connect<> net_rhs_in25_L0 (platform.src[57], mm_graph0.in_rhs[25][0]);
connect<> net_rhs_in26_L0 (platform.src[58], mm_graph0.in_rhs[26][0]);
connect<> net_rhs_in27_L0 (platform.src[59], mm_graph0.in_rhs[27][0]);
connect<> net_rhs_in28_L0 (platform.src[60], mm_graph0.in_rhs[28][0]);
connect<> net_rhs_in29_L0 (platform.src[61], mm_graph0.in_rhs[29][0]);
connect<> net_rhs_in30_L0 (platform.src[62], mm_graph0.in_rhs[30][0]);
connect<> net_rhs_in31_L0 (platform.src[63], mm_graph0.in_rhs[31][0]);
connect<> net_rhs_in32_L0 (platform.src[64], mm_graph0.in_rhs[32][0]);
connect<> net_rhs_in33_L0 (platform.src[65], mm_graph0.in_rhs[33][0]);
connect<> net_rhs_in34_L0 (platform.src[66], mm_graph0.in_rhs[34][0]);
connect<> net_rhs_in35_L0 (platform.src[67], mm_graph0.in_rhs[35][0]);
connect<> net_rhs_in36_L0 (platform.src[68], mm_graph0.in_rhs[36][0]);
connect<> net_rhs_in37_L0 (platform.src[69], mm_graph0.in_rhs[37][0]);
connect<> net_rhs_in38_L0 (platform.src[70], mm_graph0.in_rhs[38][0]);
connect<> net_rhs_in39_L0 (platform.src[71], mm_graph0.in_rhs[39][0]);
connect<> net_rhs_in40_L0 (platform.src[72], mm_graph0.in_rhs[40][0]);
connect<> net_rhs_in41_L0 (platform.src[73], mm_graph0.in_rhs[41][0]);
connect<> net_rhs_in42_L0 (platform.src[74], mm_graph0.in_rhs[42][0]);
connect<> net_rhs_in43_L0 (platform.src[75], mm_graph0.in_rhs[43][0]);
connect<> net_rhs_in44_L0 (platform.src[76], mm_graph0.in_rhs[44][0]);
connect<> net_rhs_in45_L0 (platform.src[77], mm_graph0.in_rhs[45][0]);
connect<> net_rhs_in46_L0 (platform.src[78], mm_graph0.in_rhs[46][0]);
connect<> net_rhs_in47_L0 (platform.src[79], mm_graph0.in_rhs[47][0]);
...
connect<> net_out32_L0 (mm_graph0.out[32], platform.sink[32]);
connect<> net_out33_L0 (mm_graph0.out[33], platform.sink[33]);
connect<> net_out34_L0 (mm_graph0.out[34], platform.sink[34]);
connect<> net_out35_L0 (mm_graph0.out[35], platform.sink[35]);
connect<> net_out36_L0 (mm_graph0.out[36], platform.sink[36]);
connect<> net_out37_L0 (mm_graph0.out[37], platform.sink[37]);
connect<> net_out38_L0 (mm_graph0.out[38], platform.sink[38]);
connect<> net_out39_L0 (mm_graph0.out[39], platform.sink[39]);
connect<> net_out40_L0 (mm_graph0.out[40], platform.sink[40]);
connect<> net_out41_L0 (mm_graph0.out[41], platform.sink[41]);
connect<> net_out42_L0 (mm_graph0.out[42], platform.sink[42]);
connect<> net_out43_L0 (mm_graph0.out[43], platform.sink[43]);
connect<> net_out44_L0 (mm_graph0.out[44], platform.sink[44]);
connect<> net_out45_L0 (mm_graph0.out[45], platform.sink[45]);
connect<> net_out46_L0 (mm_graph0.out[46], platform.sink[46]);
connect<> net_out47_L0 (mm_graph0.out[47], platform.sink[47]);
#ifdef __AIESIM__
