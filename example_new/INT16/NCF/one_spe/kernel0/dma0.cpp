...
void sendB(ap_uint<PLIO_WIDTH> b_buf[Z*Y][PACK_IN*RIGHT_SIZE],
           axis_stream& txB0, axis_stream& txB1, axis_stream& txB2, axis_stream& txB3, axis_stream& txB4, axis_stream& txB5, axis_stream& txB6, axis_stream& txB7, 
           bool enable){
...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
             ...
             axis_stream& rxC36, axis_stream& rxC37, axis_stream& rxC38, axis_stream& rxC39,
             axis_stream& rxC40, axis_stream& rxC41, axis_stream& rxC42, axis_stream& rxC43,
             axis_stream& rxC44, axis_stream& rxC45, axis_stream& rxC46, axis_stream& rxC47,
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendA<12>(buff1_A[12],txA24,txA25,rd>0&&rd<Total_rd+1);
            sendA<13>(buff1_A[13],txA26,txA27,rd>0&&rd<Total_rd+1);
            sendA<14>(buff1_A[14],txA28,txA29,rd>0&&rd<Total_rd+1);
            sendA<15>(buff1_A[15],txA30,txA31,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff1_B[0],txB0,txB1,txB2,txB3,txB4,txB5,txB6,txB7,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB8,txB9,txB10,txB11,txB12,txB13,txB14,txB15,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB16,txB17,txB18,txB19,txB20,txB21,txB22,txB23,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB24,txB25,txB26,txB27,txB28,txB29,txB30,txB31,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB32,txB33,txB34,txB35,txB36,txB37,txB38,txB39,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB40,txB41,txB42,txB43,txB44,txB45,txB46,txB47,rd>0&&rd<Total_rd+1);
            ...
            receiveC<36>(buff0_C[36],rxC36, rd>0&&rd<Total_rd+1);
            receiveC<37>(buff0_C[37],rxC37, rd>0&&rd<Total_rd+1);
            receiveC<38>(buff0_C[38],rxC38, rd>0&&rd<Total_rd+1);
            receiveC<39>(buff0_C[39],rxC39, rd>0&&rd<Total_rd+1);
            receiveC<40>(buff0_C[40],rxC40, rd>0&&rd<Total_rd+1);
            receiveC<41>(buff0_C[41],rxC41, rd>0&&rd<Total_rd+1);
            receiveC<42>(buff0_C[42],rxC42, rd>0&&rd<Total_rd+1);
            receiveC<43>(buff0_C[43],rxC43, rd>0&&rd<Total_rd+1);
            receiveC<44>(buff0_C[44],rxC44, rd>0&&rd<Total_rd+1);
            receiveC<45>(buff0_C[45],rxC45, rd>0&&rd<Total_rd+1);
            receiveC<46>(buff0_C[46],rxC46, rd>0&&rd<Total_rd+1);
            receiveC<47>(buff0_C[47],rxC47, rd>0&&rd<Total_rd+1);
            ...
            sendA<12>(buff0_A[12],txA24,txA25,rd>0&&rd<Total_rd+1);
            sendA<13>(buff0_A[13],txA26,txA27,rd>0&&rd<Total_rd+1);
            sendA<14>(buff0_A[14],txA28,txA29,rd>0&&rd<Total_rd+1);
            sendA<15>(buff0_A[15],txA30,txA31,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff0_B[0],txB0,txB1,txB2,txB3,txB4,txB5,txB6,txB7,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB8,txB9,txB10,txB11,txB12,txB13,txB14,txB15,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB16,txB17,txB18,txB19,txB20,txB21,txB22,txB23,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB24,txB25,txB26,txB27,txB28,txB29,txB30,txB31,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB32,txB33,txB34,txB35,txB36,txB37,txB38,txB39,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB40,txB41,txB42,txB43,txB44,txB45,txB46,txB47,rd>0&&rd<Total_rd+1);
            ...
            receiveC<36>(buff1_C[36],rxC36, rd>0&&rd<Total_rd+1);
            receiveC<37>(buff1_C[37],rxC37, rd>0&&rd<Total_rd+1);
            receiveC<38>(buff1_C[38],rxC38, rd>0&&rd<Total_rd+1);
            receiveC<39>(buff1_C[39],rxC39, rd>0&&rd<Total_rd+1);
            receiveC<40>(buff1_C[40],rxC40, rd>0&&rd<Total_rd+1);
            receiveC<41>(buff1_C[41],rxC41, rd>0&&rd<Total_rd+1);
            receiveC<42>(buff1_C[42],rxC42, rd>0&&rd<Total_rd+1);
            receiveC<43>(buff1_C[43],rxC43, rd>0&&rd<Total_rd+1);
            receiveC<44>(buff1_C[44],rxC44, rd>0&&rd<Total_rd+1);
            receiveC<45>(buff1_C[45],rxC45, rd>0&&rd<Total_rd+1);
            receiveC<46>(buff1_C[46],rxC46, rd>0&&rd<Total_rd+1);
            receiveC<47>(buff1_C[47],rxC47, rd>0&&rd<Total_rd+1);
...
void dma0(ap_uint<AXI_WIDTH_A>* ina, ap_uint<AXI_WIDTH_B>* inb, ap_uint<AXI_WIDTH_C>* out0,
    ...
    #pragma HLS interface axis port=rxC36
    #pragma HLS interface axis port=rxC37
    #pragma HLS interface axis port=rxC38
    #pragma HLS interface axis port=rxC39
    #pragma HLS interface axis port=rxC40
    #pragma HLS interface axis port=rxC41
    #pragma HLS interface axis port=rxC42
    #pragma HLS interface axis port=rxC43
    #pragma HLS interface axis port=rxC44
    #pragma HLS interface axis port=rxC45
    #pragma HLS interface axis port=rxC46
    #pragma HLS interface axis port=rxC47
    ...
    compute(dataA_out, dataB_out, dataC_in,
            ...
            rxC36, rxC37, rxC38, rxC39,
            rxC40, rxC41, rxC42, rxC43,
            rxC44, rxC45, rxC46, rxC47,
            TX, TY, TZ);
