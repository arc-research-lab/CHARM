...
simulation::platform<32, 20> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_lhs_in2_L1 (platform.src[10], mm_graph1.in_lhs[2][0]);
connect<> net_lhs_in3_L1 (platform.src[11], mm_graph1.in_lhs[3][0]);

connect<> net_rhs_in0_L0 (platform.src[12], mm_graph0.in_rhs[0][0]);
connect<> net_rhs_in1_L0 (platform.src[13], mm_graph0.in_rhs[1][0]);
connect<> net_rhs_in2_L0 (platform.src[14], mm_graph0.in_rhs[2][0]);
connect<> net_rhs_in3_L0 (platform.src[15], mm_graph0.in_rhs[3][0]);
connect<> net_rhs_in4_L0 (platform.src[16], mm_graph0.in_rhs[4][0]);
connect<> net_rhs_in5_L0 (platform.src[17], mm_graph0.in_rhs[5][0]);
connect<> net_rhs_in6_L0 (platform.src[18], mm_graph0.in_rhs[6][0]);
connect<> net_rhs_in7_L0 (platform.src[19], mm_graph0.in_rhs[7][0]);
connect<> net_rhs_in8_L0 (platform.src[20], mm_graph0.in_rhs[8][0]);
connect<> net_rhs_in9_L0 (platform.src[21], mm_graph0.in_rhs[9][0]);
connect<> net_rhs_in10_L0 (platform.src[22], mm_graph0.in_rhs[10][0]);
connect<> net_rhs_in11_L0 (platform.src[23], mm_graph0.in_rhs[11][0]);
connect<> net_rhs_in12_L0 (platform.src[24], mm_graph0.in_rhs[12][0]);
connect<> net_rhs_in13_L0 (platform.src[25], mm_graph0.in_rhs[13][0]);
connect<> net_rhs_in14_L0 (platform.src[26], mm_graph0.in_rhs[14][0]);
connect<> net_rhs_in15_L0 (platform.src[27], mm_graph0.in_rhs[15][0]);
connect<> net_rhs_in0_L1 (platform.src[28], mm_graph1.in_rhs[0][0]);
connect<> net_rhs_in1_L1 (platform.src[29], mm_graph1.in_rhs[1][0]);
connect<> net_rhs_in2_L1 (platform.src[30], mm_graph1.in_rhs[2][0]);
connect<> net_rhs_in3_L1 (platform.src[31], mm_graph1.in_rhs[3][0]);
