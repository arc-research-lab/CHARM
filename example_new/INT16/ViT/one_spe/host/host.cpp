...
int main(int argc, char** argv) {
    ...
    for (int i=0; i<NUM_LARYER; i++){
        for (int j=0; j<4; j++){
            float temp;
            if (j==0){
                temp = (float)(layer_in[i][j])/(float)(M_acc);
                layer[i][j]=ceil(temp)*M_acc;
            }
            else if(j==1){
                temp = (float)(layer_in[i][j])/(float)(K_acc);
                layer[i][j]=ceil(temp)*K_acc;
            }
            else if(j==2){
                temp = (float)(layer_in[i][j])/(float)(N_acc);
                layer[i][j]=ceil(temp)*N_acc;
            }
            else{
    ...
    //layer0
    std::vector<std::vector<int16_t>>layer0_in0(layer[0][0],std::vector<int16_t>(layer[0][1],1.0));
    std::vector<std::vector<int16_t>>layer0_in1(layer[0][1],std::vector<int16_t>(layer[0][2],1.0));
    std::vector<std::vector<int16_t>>layer0_golden(layer[0][0],std::vector<int16_t>(layer[0][2],1.0));

    //layer1
    std::vector<std::vector<int16_t>>layer1_in0(layer[1][0],std::vector<int16_t>(layer[1][1],1.0));
    std::vector<std::vector<int16_t>>layer1_in1(layer[1][1],std::vector<int16_t>(layer[1][2],1.0));
    std::vector<std::vector<int16_t>>layer1_golden(layer[1][0],std::vector<int16_t>(layer[1][2],1.0));

    //layer2
    std::vector<std::vector<int16_t>>layer2_in0(layer[2][0],std::vector<int16_t>(layer[2][1],1.0));
    std::vector<std::vector<int16_t>>layer2_in1(layer[2][1],std::vector<int16_t>(layer[2][2],1.0));
    std::vector<std::vector<int16_t>>layer2_golden(layer[2][0],std::vector<int16_t>(layer[2][2],1.0));

    //layer3
    std::vector<std::vector<int16_t>>layer3_in0(layer[3][0],std::vector<int16_t>(layer[3][1],1.0));
    std::vector<std::vector<int16_t>>layer3_in1(layer[3][1],std::vector<int16_t>(layer[3][2],1.0));
    std::vector<std::vector<int16_t>>layer3_golden(layer[3][0],std::vector<int16_t>(layer[3][2],1.0));

    //layer4
    std::vector<std::vector<int16_t>>layer4_in0(layer[4][0],std::vector<int16_t>(layer[4][1],1.0));
    std::vector<std::vector<int16_t>>layer4_in1(layer[4][1],std::vector<int16_t>(layer[4][2],1.0));
    std::vector<std::vector<int16_t>>layer4_golden(layer[4][0],std::vector<int16_t>(layer[4][2],1.0));

    //layer5
    std::vector<std::vector<int16_t>>layer5_in0(layer[5][0],std::vector<int16_t>(layer[5][1],1.0));
    std::vector<std::vector<int16_t>>layer5_in1(layer[5][1],std::vector<int16_t>(layer[5][2],1.0));
    std::vector<std::vector<int16_t>>layer5_golden(layer[5][0],std::vector<int16_t>(layer[5][2],1.0));

    //layer6
    std::vector<std::vector<int16_t>>layer6_in0(layer[6][0],std::vector<int16_t>(layer[6][1],1.0));
    std::vector<std::vector<int16_t>>layer6_in1(layer[6][1],std::vector<int16_t>(layer[6][2],1.0));
    std::vector<std::vector<int16_t>>layer6_golden(layer[6][0],std::vector<int16_t>(layer[6][2],1.0));
    ...
    // start input kernels run handles
        ...
        dma_run = dma0(bohdl_layer0_in0, bohdl_layer0_in1,bohdl_layer0_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[0][0]/(M_acc)),(layer[0][1]/K_acc),(layer[0][2]/N_acc));
            dma_run.wait();
        ...
        dma_run = dma0(bohdl_layer1_in0, bohdl_layer1_in1,bohdl_layer1_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[1][0]/(M_acc)),(layer[1][1]/K_acc),(layer[1][2]/N_acc));
            dma_run.wait();
        ...
        dma_run = dma0(bohdl_layer2_in0, bohdl_layer2_in1,bohdl_layer2_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[2][0]/(M_acc)),(layer[2][1]/K_acc),(layer[2][2]/N_acc));
        dma_run.wait();
        ...
        dma_run = dma0(bohdl_layer3_in0, bohdl_layer3_in1,bohdl_layer3_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[3][0]/(M_acc)),(layer[3][1]/K_acc),(layer[3][2]/N_acc));
        dma_run.wait();
        ...
        dma_run = dma0(bohdl_layer4_in0, bohdl_layer4_in1,bohdl_layer4_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[4][0]/(M_acc)),(layer[4][1]/K_acc),(layer[4][2]/N_acc));
        dma_run.wait();
        ...
        for (int j=0;j<batch_size;j++){
            ...
            dma_run = dma0(bohdl_layer5_in0, bohdl_layer5_in1,bohdl_layer5_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[5][0]/(M_acc)),(layer[5][1]/K_acc),(layer[5][2]/N_acc));
            dma_run.wait();
            ...
            dma_run = dma0(bohdl_layer6_in0, bohdl_layer6_in1,bohdl_layer6_out,
                ...
                nullptr, nullptr, nullptr, nullptr,
                nullptr, nullptr, nullptr, nullptr,
                (layer[6][0]/(M_acc)),(layer[6][1]/K_acc),(layer[6][2]/N_acc));
            dma_run.wait();
