...
class mm_k1_B6_L0: public graph {
  private:
  ...
  public:
    ...
    mm_k1_B6_L0() {
      ...
      for (int i=0; i<L0_NUM_KERNEL;i++){
        if(i==0){
          mm[i] = kernel::create(mm5_kernel0_L0);
          source(mm[i]) = "mm5_kernel0_L0.cc";
        }
        else if(i==L0_NUM_KERNEL-1){
          mm[i] = kernel::create(mm5_kernel2_L0);
          source(mm[i]) = "mm5_kernel2_L0.cc";
        }
        
        else{
          mm[i] = kernel::create(mm5_kernel1_L0);
          source(mm[i]) = "mm5_kernel1_L0.cc";
        }
