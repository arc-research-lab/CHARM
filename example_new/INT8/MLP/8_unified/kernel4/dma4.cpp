...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
              axis_stream& txA0, axis_stream& txA1, axis_stream& txA2, axis_stream& txB0, axis_stream& txB1, axis_stream& rxC0, axis_stream& rxC1, axis_stream& rxC2,const int TX, const int TY, const int TZ){
...
void dma4(ap_uint<AXI_WIDTH_A>* ina, ap_uint<AXI_WIDTH_B>* inb, ap_uint<AXI_WIDTH_C>* out0,
          axis_stream& txA0, axis_stream& txA1, axis_stream& txA2, axis_stream& txB0, axis_stream& txB1, axis_stream& rxC0, axis_stream& rxC1, axis_stream& rxC2,const int TX, const int TY, const int TZ){
    ...
    compute(dataA_out, dataB_out, dataC_in,
             txA0, txA1, txA2, txB0, txB1, rxC0, rxC1, rxC2,TX, TY, TZ);
