...
int main(int argc, char** argv) {
    ...
    //layer0
    std::vector<std::vector<int8_t>>layer0_in0(layer[0][0],std::vector<int8_t>(layer[0][1],1.0));
    std::vector<std::vector<int8_t>>layer0_in1(layer[0][1],std::vector<int8_t>(layer[0][2],1.0));
    std::vector<std::vector<int8_t>>layer0_golden(layer[0][0],std::vector<int8_t>(layer[0][2],1.0));

    //layer1
    std::vector<std::vector<int8_t>>layer1_in0(layer[1][0],std::vector<int8_t>(layer[1][1],1.0));
    std::vector<std::vector<int8_t>>layer1_in1(layer[1][1],std::vector<int8_t>(layer[1][2],1.0));
    std::vector<std::vector<int8_t>>layer1_golden(layer[1][0],std::vector<int8_t>(layer[1][2],1.0));

    //layer2
    std::vector<std::vector<int8_t>>layer2_in0(layer[2][0],std::vector<int8_t>(layer[2][1],1.0));
    std::vector<std::vector<int8_t>>layer2_in1(layer[2][1],std::vector<int8_t>(layer[2][2],1.0));
    std::vector<std::vector<int8_t>>layer2_golden(layer[2][0],std::vector<int8_t>(layer[2][2],1.0));

    //layer3
    std::vector<std::vector<int8_t>>layer3_in0(layer[3][0],std::vector<int8_t>(layer[3][1],1.0));
    std::vector<std::vector<int8_t>>layer3_in1(layer[3][1],std::vector<int8_t>(layer[3][2],1.0));
    std::vector<std::vector<int8_t>>layer3_golden(layer[3][0],std::vector<int8_t>(layer[3][2],1.0));

    //layer4
    std::vector<std::vector<int8_t>>layer4_in0(layer[4][0],std::vector<int8_t>(layer[4][1],1.0));
    std::vector<std::vector<int8_t>>layer4_in1(layer[4][1],std::vector<int8_t>(layer[4][2],1.0));
    std::vector<std::vector<int8_t>>layer4_golden(layer[4][0],std::vector<int8_t>(layer[4][2],1.0));

    //layer5
    std::vector<std::vector<int8_t>>layer5_in0(layer[5][0],std::vector<int8_t>(layer[5][1],1.0));
    std::vector<std::vector<int8_t>>layer5_in1(layer[5][1],std::vector<int8_t>(layer[5][2],1.0));
    std::vector<std::vector<int8_t>>layer5_golden(layer[5][0],std::vector<int8_t>(layer[5][2],1.0));

    //layer6
    std::vector<std::vector<int8_t>>layer6_in0(layer[6][0],std::vector<int8_t>(layer[6][1],1.0));
    std::vector<std::vector<int8_t>>layer6_in1(layer[6][1],std::vector<int8_t>(layer[6][2],1.0));
    std::vector<std::vector<int8_t>>layer6_golden(layer[6][0],std::vector<int8_t>(layer[6][2],1.0));
