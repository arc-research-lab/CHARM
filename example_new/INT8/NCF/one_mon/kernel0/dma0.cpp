...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendB<0>(buff1_B[0],txB0,txB2,txB4,txB6,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB1,txB3,txB5,txB7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB8,txB10,txB12,txB14,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB9,txB11,txB13,txB15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB16,txB18,txB20,txB22,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB17,txB19,txB21,txB23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff1_B[6],txB24,txB26,txB28,txB30,rd>0&&rd<Total_rd+1);
            sendB<7>(buff1_B[7],txB25,txB27,txB29,txB31,rd>0&&rd<Total_rd+1);
            sendB<8>(buff1_B[8],txB32,txB34,txB36,txB38,rd>0&&rd<Total_rd+1);
            sendB<9>(buff1_B[9],txB33,txB35,txB37,txB39,rd>0&&rd<Total_rd+1);
            sendB<10>(buff1_B[10],txB40,txB42,txB44,txB46,rd>0&&rd<Total_rd+1);
            sendB<11>(buff1_B[11],txB41,txB43,txB45,txB47,rd>0&&rd<Total_rd+1);
            ...
            sendB<0>(buff0_B[0],txB0,txB2,txB4,txB6,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB1,txB3,txB5,txB7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB8,txB10,txB12,txB14,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB9,txB11,txB13,txB15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB16,txB18,txB20,txB22,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB17,txB19,txB21,txB23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff0_B[6],txB24,txB26,txB28,txB30,rd>0&&rd<Total_rd+1);
            sendB<7>(buff0_B[7],txB25,txB27,txB29,txB31,rd>0&&rd<Total_rd+1);
            sendB<8>(buff0_B[8],txB32,txB34,txB36,txB38,rd>0&&rd<Total_rd+1);
            sendB<9>(buff0_B[9],txB33,txB35,txB37,txB39,rd>0&&rd<Total_rd+1);
            sendB<10>(buff0_B[10],txB40,txB42,txB44,txB46,rd>0&&rd<Total_rd+1);
            sendB<11>(buff0_B[11],txB41,txB43,txB45,txB47,rd>0&&rd<Total_rd+1);
