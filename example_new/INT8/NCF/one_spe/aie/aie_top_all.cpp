...
simulation::platform<96, 24> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_lhs_in16_L0 (platform.src[16], mm_graph0.in_lhs[8][0]);
connect<> net_lhs_in17_L0 (platform.src[17], mm_graph0.in_lhs[8][1]);
connect<> net_lhs_in18_L0 (platform.src[18], mm_graph0.in_lhs[9][0]);
connect<> net_lhs_in19_L0 (platform.src[19], mm_graph0.in_lhs[9][1]);
connect<> net_lhs_in20_L0 (platform.src[20], mm_graph0.in_lhs[10][0]);
connect<> net_lhs_in21_L0 (platform.src[21], mm_graph0.in_lhs[10][1]);
connect<> net_lhs_in22_L0 (platform.src[22], mm_graph0.in_lhs[11][0]);
connect<> net_lhs_in23_L0 (platform.src[23], mm_graph0.in_lhs[11][1]);
connect<> net_lhs_in24_L0 (platform.src[24], mm_graph0.in_lhs[12][0]);
connect<> net_lhs_in25_L0 (platform.src[25], mm_graph0.in_lhs[12][1]);
connect<> net_lhs_in26_L0 (platform.src[26], mm_graph0.in_lhs[13][0]);
connect<> net_lhs_in27_L0 (platform.src[27], mm_graph0.in_lhs[13][1]);
connect<> net_lhs_in28_L0 (platform.src[28], mm_graph0.in_lhs[14][0]);
connect<> net_lhs_in29_L0 (platform.src[29], mm_graph0.in_lhs[14][1]);
connect<> net_lhs_in30_L0 (platform.src[30], mm_graph0.in_lhs[15][0]);
connect<> net_lhs_in31_L0 (platform.src[31], mm_graph0.in_lhs[15][1]);
connect<> net_lhs_in32_L0 (platform.src[32], mm_graph0.in_lhs[16][0]);
connect<> net_lhs_in33_L0 (platform.src[33], mm_graph0.in_lhs[16][1]);
connect<> net_lhs_in34_L0 (platform.src[34], mm_graph0.in_lhs[17][0]);
connect<> net_lhs_in35_L0 (platform.src[35], mm_graph0.in_lhs[17][1]);
connect<> net_lhs_in36_L0 (platform.src[36], mm_graph0.in_lhs[18][0]);
connect<> net_lhs_in37_L0 (platform.src[37], mm_graph0.in_lhs[18][1]);
connect<> net_lhs_in38_L0 (platform.src[38], mm_graph0.in_lhs[19][0]);
connect<> net_lhs_in39_L0 (platform.src[39], mm_graph0.in_lhs[19][1]);
connect<> net_lhs_in40_L0 (platform.src[40], mm_graph0.in_lhs[20][0]);
connect<> net_lhs_in41_L0 (platform.src[41], mm_graph0.in_lhs[20][1]);
connect<> net_lhs_in42_L0 (platform.src[42], mm_graph0.in_lhs[21][0]);
connect<> net_lhs_in43_L0 (platform.src[43], mm_graph0.in_lhs[21][1]);
connect<> net_lhs_in44_L0 (platform.src[44], mm_graph0.in_lhs[22][0]);
connect<> net_lhs_in45_L0 (platform.src[45], mm_graph0.in_lhs[22][1]);
connect<> net_lhs_in46_L0 (platform.src[46], mm_graph0.in_lhs[23][0]);
connect<> net_lhs_in47_L0 (platform.src[47], mm_graph0.in_lhs[23][1]);

connect<> net_rhs_in0_L0 (platform.src[48], mm_graph0.in_rhs[0][0]);
connect<> net_rhs_in1_L0 (platform.src[49], mm_graph0.in_rhs[0][1]);
connect<> net_rhs_in2_L0 (platform.src[50], mm_graph0.in_rhs[1][0]);
connect<> net_rhs_in3_L0 (platform.src[51], mm_graph0.in_rhs[1][1]);
connect<> net_rhs_in4_L0 (platform.src[52], mm_graph0.in_rhs[2][0]);
connect<> net_rhs_in5_L0 (platform.src[53], mm_graph0.in_rhs[2][1]);
connect<> net_rhs_in6_L0 (platform.src[54], mm_graph0.in_rhs[3][0]);
connect<> net_rhs_in7_L0 (platform.src[55], mm_graph0.in_rhs[3][1]);
connect<> net_rhs_in8_L0 (platform.src[56], mm_graph0.in_rhs[4][0]);
connect<> net_rhs_in9_L0 (platform.src[57], mm_graph0.in_rhs[4][1]);
connect<> net_rhs_in10_L0 (platform.src[58], mm_graph0.in_rhs[5][0]);
connect<> net_rhs_in11_L0 (platform.src[59], mm_graph0.in_rhs[5][1]);
connect<> net_rhs_in12_L0 (platform.src[60], mm_graph0.in_rhs[6][0]);
connect<> net_rhs_in13_L0 (platform.src[61], mm_graph0.in_rhs[6][1]);
connect<> net_rhs_in14_L0 (platform.src[62], mm_graph0.in_rhs[7][0]);
connect<> net_rhs_in15_L0 (platform.src[63], mm_graph0.in_rhs[7][1]);
connect<> net_rhs_in16_L0 (platform.src[64], mm_graph0.in_rhs[8][0]);
connect<> net_rhs_in17_L0 (platform.src[65], mm_graph0.in_rhs[8][1]);
connect<> net_rhs_in18_L0 (platform.src[66], mm_graph0.in_rhs[9][0]);
connect<> net_rhs_in19_L0 (platform.src[67], mm_graph0.in_rhs[9][1]);
connect<> net_rhs_in20_L0 (platform.src[68], mm_graph0.in_rhs[10][0]);
connect<> net_rhs_in21_L0 (platform.src[69], mm_graph0.in_rhs[10][1]);
connect<> net_rhs_in22_L0 (platform.src[70], mm_graph0.in_rhs[11][0]);
connect<> net_rhs_in23_L0 (platform.src[71], mm_graph0.in_rhs[11][1]);
connect<> net_rhs_in24_L0 (platform.src[72], mm_graph0.in_rhs[12][0]);
connect<> net_rhs_in25_L0 (platform.src[73], mm_graph0.in_rhs[12][1]);
connect<> net_rhs_in26_L0 (platform.src[74], mm_graph0.in_rhs[13][0]);
connect<> net_rhs_in27_L0 (platform.src[75], mm_graph0.in_rhs[13][1]);
connect<> net_rhs_in28_L0 (platform.src[76], mm_graph0.in_rhs[14][0]);
connect<> net_rhs_in29_L0 (platform.src[77], mm_graph0.in_rhs[14][1]);
connect<> net_rhs_in30_L0 (platform.src[78], mm_graph0.in_rhs[15][0]);
connect<> net_rhs_in31_L0 (platform.src[79], mm_graph0.in_rhs[15][1]);
connect<> net_rhs_in32_L0 (platform.src[80], mm_graph0.in_rhs[16][0]);
connect<> net_rhs_in33_L0 (platform.src[81], mm_graph0.in_rhs[16][1]);
connect<> net_rhs_in34_L0 (platform.src[82], mm_graph0.in_rhs[17][0]);
connect<> net_rhs_in35_L0 (platform.src[83], mm_graph0.in_rhs[17][1]);
connect<> net_rhs_in36_L0 (platform.src[84], mm_graph0.in_rhs[18][0]);
connect<> net_rhs_in37_L0 (platform.src[85], mm_graph0.in_rhs[18][1]);
connect<> net_rhs_in38_L0 (platform.src[86], mm_graph0.in_rhs[19][0]);
connect<> net_rhs_in39_L0 (platform.src[87], mm_graph0.in_rhs[19][1]);
connect<> net_rhs_in40_L0 (platform.src[88], mm_graph0.in_rhs[20][0]);
connect<> net_rhs_in41_L0 (platform.src[89], mm_graph0.in_rhs[20][1]);
connect<> net_rhs_in42_L0 (platform.src[90], mm_graph0.in_rhs[21][0]);
connect<> net_rhs_in43_L0 (platform.src[91], mm_graph0.in_rhs[21][1]);
connect<> net_rhs_in44_L0 (platform.src[92], mm_graph0.in_rhs[22][0]);
connect<> net_rhs_in45_L0 (platform.src[93], mm_graph0.in_rhs[22][1]);
connect<> net_rhs_in46_L0 (platform.src[94], mm_graph0.in_rhs[23][0]);
connect<> net_rhs_in47_L0 (platform.src[95], mm_graph0.in_rhs[23][1]);
