...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendA<8>(buff1_A[8],txA16,txA18,rd>0&&rd<Total_rd+1);
            sendA<9>(buff1_A[9],txA17,txA19,rd>0&&rd<Total_rd+1);
            sendA<10>(buff1_A[10],txA20,txA22,rd>0&&rd<Total_rd+1);
            sendA<11>(buff1_A[11],txA21,txA23,rd>0&&rd<Total_rd+1);
            sendA<12>(buff1_A[12],txA24,txA26,rd>0&&rd<Total_rd+1);
            sendA<13>(buff1_A[13],txA25,txA27,rd>0&&rd<Total_rd+1);
            sendA<14>(buff1_A[14],txA28,txA30,rd>0&&rd<Total_rd+1);
            sendA<15>(buff1_A[15],txA29,txA31,rd>0&&rd<Total_rd+1);
            sendA<16>(buff1_A[16],txA32,txA34,rd>0&&rd<Total_rd+1);
            sendA<17>(buff1_A[17],txA33,txA35,rd>0&&rd<Total_rd+1);
            sendA<18>(buff1_A[18],txA36,txA38,rd>0&&rd<Total_rd+1);
            sendA<19>(buff1_A[19],txA37,txA39,rd>0&&rd<Total_rd+1);
            sendA<20>(buff1_A[20],txA40,txA42,rd>0&&rd<Total_rd+1);
            sendA<21>(buff1_A[21],txA41,txA43,rd>0&&rd<Total_rd+1);
            sendA<22>(buff1_A[22],txA44,txA46,rd>0&&rd<Total_rd+1);
            sendA<23>(buff1_A[23],txA45,txA47,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff1_B[0],txB0,txB2,txB4,txB6,txB8,txB10,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB1,txB3,txB5,txB7,txB9,txB11,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB12,txB14,txB16,txB18,txB20,txB22,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB13,txB15,txB17,txB19,txB21,txB23,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB24,txB26,txB28,txB30,txB32,txB34,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB25,txB27,txB29,txB31,txB33,txB35,rd>0&&rd<Total_rd+1);
            sendB<6>(buff1_B[6],txB36,txB38,txB40,txB42,txB44,txB46,rd>0&&rd<Total_rd+1);
            sendB<7>(buff1_B[7],txB37,txB39,txB41,txB43,txB45,txB47,rd>0&&rd<Total_rd+1);
            ...
            sendA<8>(buff0_A[8],txA16,txA18,rd>0&&rd<Total_rd+1);
            sendA<9>(buff0_A[9],txA17,txA19,rd>0&&rd<Total_rd+1);
            sendA<10>(buff0_A[10],txA20,txA22,rd>0&&rd<Total_rd+1);
            sendA<11>(buff0_A[11],txA21,txA23,rd>0&&rd<Total_rd+1);
            sendA<12>(buff0_A[12],txA24,txA26,rd>0&&rd<Total_rd+1);
            sendA<13>(buff0_A[13],txA25,txA27,rd>0&&rd<Total_rd+1);
            sendA<14>(buff0_A[14],txA28,txA30,rd>0&&rd<Total_rd+1);
            sendA<15>(buff0_A[15],txA29,txA31,rd>0&&rd<Total_rd+1);
            sendA<16>(buff0_A[16],txA32,txA34,rd>0&&rd<Total_rd+1);
            sendA<17>(buff0_A[17],txA33,txA35,rd>0&&rd<Total_rd+1);
            sendA<18>(buff0_A[18],txA36,txA38,rd>0&&rd<Total_rd+1);
            sendA<19>(buff0_A[19],txA37,txA39,rd>0&&rd<Total_rd+1);
            sendA<20>(buff0_A[20],txA40,txA42,rd>0&&rd<Total_rd+1);
            sendA<21>(buff0_A[21],txA41,txA43,rd>0&&rd<Total_rd+1);
            sendA<22>(buff0_A[22],txA44,txA46,rd>0&&rd<Total_rd+1);
            sendA<23>(buff0_A[23],txA45,txA47,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff0_B[0],txB0,txB2,txB4,txB6,txB8,txB10,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB1,txB3,txB5,txB7,txB9,txB11,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB12,txB14,txB16,txB18,txB20,txB22,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB13,txB15,txB17,txB19,txB21,txB23,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB24,txB26,txB28,txB30,txB32,txB34,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB25,txB27,txB29,txB31,txB33,txB35,rd>0&&rd<Total_rd+1);
            sendB<6>(buff0_B[6],txB36,txB38,txB40,txB42,txB44,txB46,rd>0&&rd<Total_rd+1);
            sendB<7>(buff0_B[7],txB37,txB39,txB41,txB43,txB45,txB47,rd>0&&rd<Total_rd+1);
