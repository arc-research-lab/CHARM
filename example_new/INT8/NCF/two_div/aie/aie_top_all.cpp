...
PLIO* out6_L1 = new PLIO("out6_L1", adf::plio_128_bits, "data/output22.txt",230);
PLIO* out7_L1 = new PLIO("out7_L1", adf::plio_128_bits, "data/output23.txt",230);

simulation::platform<80, 24> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_lhs_in1_L1 (platform.src[33], mm_graph1.in_lhs[1][0]);
connect<> net_lhs_in2_L1 (platform.src[34], mm_graph1.in_lhs[2][0]);
connect<> net_lhs_in3_L1 (platform.src[35], mm_graph1.in_lhs[3][0]);
connect<> net_lhs_in4_L1 (platform.src[36], mm_graph1.in_lhs[4][0]);
connect<> net_lhs_in5_L1 (platform.src[37], mm_graph1.in_lhs[5][0]);
connect<> net_lhs_in6_L1 (platform.src[38], mm_graph1.in_lhs[6][0]);
connect<> net_lhs_in7_L1 (platform.src[39], mm_graph1.in_lhs[7][0]);

connect<> net_rhs_in0_L0 (platform.src[40], mm_graph0.in_rhs[0][0]);
connect<> net_rhs_in1_L0 (platform.src[41], mm_graph0.in_rhs[0][1]);
connect<> net_rhs_in2_L0 (platform.src[42], mm_graph0.in_rhs[1][0]);
connect<> net_rhs_in3_L0 (platform.src[43], mm_graph0.in_rhs[1][1]);
connect<> net_rhs_in4_L0 (platform.src[44], mm_graph0.in_rhs[2][0]);
connect<> net_rhs_in5_L0 (platform.src[45], mm_graph0.in_rhs[2][1]);
connect<> net_rhs_in6_L0 (platform.src[46], mm_graph0.in_rhs[3][0]);
connect<> net_rhs_in7_L0 (platform.src[47], mm_graph0.in_rhs[3][1]);
connect<> net_rhs_in8_L0 (platform.src[48], mm_graph0.in_rhs[4][0]);
connect<> net_rhs_in9_L0 (platform.src[49], mm_graph0.in_rhs[4][1]);
connect<> net_rhs_in10_L0 (platform.src[50], mm_graph0.in_rhs[5][0]);
connect<> net_rhs_in11_L0 (platform.src[51], mm_graph0.in_rhs[5][1]);
connect<> net_rhs_in12_L0 (platform.src[52], mm_graph0.in_rhs[6][0]);
connect<> net_rhs_in13_L0 (platform.src[53], mm_graph0.in_rhs[6][1]);
connect<> net_rhs_in14_L0 (platform.src[54], mm_graph0.in_rhs[7][0]);
connect<> net_rhs_in15_L0 (platform.src[55], mm_graph0.in_rhs[7][1]);
connect<> net_rhs_in16_L0 (platform.src[56], mm_graph0.in_rhs[8][0]);
connect<> net_rhs_in17_L0 (platform.src[57], mm_graph0.in_rhs[8][1]);
connect<> net_rhs_in18_L0 (platform.src[58], mm_graph0.in_rhs[9][0]);
connect<> net_rhs_in19_L0 (platform.src[59], mm_graph0.in_rhs[9][1]);
connect<> net_rhs_in20_L0 (platform.src[60], mm_graph0.in_rhs[10][0]);
connect<> net_rhs_in21_L0 (platform.src[61], mm_graph0.in_rhs[10][1]);
connect<> net_rhs_in22_L0 (platform.src[62], mm_graph0.in_rhs[11][0]);
connect<> net_rhs_in23_L0 (platform.src[63], mm_graph0.in_rhs[11][1]);
connect<> net_rhs_in24_L0 (platform.src[64], mm_graph0.in_rhs[12][0]);
connect<> net_rhs_in25_L0 (platform.src[65], mm_graph0.in_rhs[12][1]);
connect<> net_rhs_in26_L0 (platform.src[66], mm_graph0.in_rhs[13][0]);
connect<> net_rhs_in27_L0 (platform.src[67], mm_graph0.in_rhs[13][1]);
connect<> net_rhs_in28_L0 (platform.src[68], mm_graph0.in_rhs[14][0]);
connect<> net_rhs_in29_L0 (platform.src[69], mm_graph0.in_rhs[14][1]);
connect<> net_rhs_in30_L0 (platform.src[70], mm_graph0.in_rhs[15][0]);
connect<> net_rhs_in31_L0 (platform.src[71], mm_graph0.in_rhs[15][1]);
connect<> net_rhs_in0_L1 (platform.src[72], mm_graph1.in_rhs[0][0]);
connect<> net_rhs_in1_L1 (platform.src[73], mm_graph1.in_rhs[1][0]);
connect<> net_rhs_in2_L1 (platform.src[74], mm_graph1.in_rhs[2][0]);
connect<> net_rhs_in3_L1 (platform.src[75], mm_graph1.in_rhs[3][0]);
connect<> net_rhs_in4_L1 (platform.src[76], mm_graph1.in_rhs[4][0]);
connect<> net_rhs_in5_L1 (platform.src[77], mm_graph1.in_rhs[5][0]);
connect<> net_rhs_in6_L1 (platform.src[78], mm_graph1.in_rhs[6][0]);
connect<> net_rhs_in7_L1 (platform.src[79], mm_graph1.in_rhs[7][0]);
...
connect<> net_out6_L1 (mm_graph1.out[6], platform.sink[22]);
connect<> net_out7_L1 (mm_graph1.out[7], platform.sink[23]);
#ifdef __AIESIM__
