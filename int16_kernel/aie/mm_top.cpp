...
PLIO *out_16 = new PLIO("out_16", adf::plio_128_bits, "./data/output_16.txt", 250);
PLIO *out_17 = new PLIO("out_17", adf::plio_128_bits, "./data/output_17.txt", 250);
PLIO *out_18 = new PLIO("out_18", adf::plio_128_bits, "./data/output_18.txt", 250);
PLIO *out_19 = new PLIO("out_19", adf::plio_128_bits, "./data/output_19.txt", 250);
PLIO *out_20 = new PLIO("out_20", adf::plio_128_bits, "./data/output_20.txt", 250);
PLIO *out_21 = new PLIO("out_21", adf::plio_128_bits, "./data/output_21.txt", 250);
PLIO *out_22 = new PLIO("out_22", adf::plio_128_bits, "./data/output_22.txt", 250);
PLIO *out_23 = new PLIO("out_23", adf::plio_128_bits, "./data/output_23.txt", 250);

mm_x96_x4_graph<COL_OFFSET,ROW_OFFSET> myGraph;
