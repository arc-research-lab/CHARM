...
#include <stdio.h>
#include "para.h"
void mm_kernel1(input_window_int8* __restrict  matA,
		input_window_int8* __restrict matB,
        input_window_int8* __restrict acc_in,
    ...
    v16acc48  acc2=ups(window_read_v16(acc_in),0);//chess_storage(bm0) 
    window_incr(acc_in,16);
	v16acc48  acc3=ups(window_read_v16(acc_in),0);//chess_storage(bm1) 
    window_incr(acc_in,16);
